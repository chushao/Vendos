        ...
        static void Main()
        {
            try {
                ...
                */
                ...
                string email = "koaswift@gmail.com", password = "cse118team8", smsPin = "";
         ...
         //       foreach (SharpVoice.Message m in v.SMS.Messages)
                ...
                #endregion
                v.Call("+17027684490", "koaswift@gmail.com");
                v.SendSMS("+19255481182", "Help I have fallen and I can't get up.");
                v.SendSMS("+17027684490", "HI");
